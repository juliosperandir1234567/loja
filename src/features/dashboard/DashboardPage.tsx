        ...
        {kpis && (
          <>
            ...
            <div className="rounded-xl bg-white p-3 ring-1 ring-neutral-200">
              ...
              <div className="mt-3 rounded-lg bg-green-50 p-2 ring-1 ring-green-200">
            ...
            <div className="rounded-xl bg-white p-3 ring-1 ring-neutral-200">
              ...
              <div className="mb-2 rounded-lg bg-green-50 p-2 ring-1 ring-green-200">
              ...
              <div className="mb-3 rounded-lg bg-red-50 p-2 ring-1 ring-red-200">
